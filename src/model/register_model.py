...
mlflow.set_tracking_uri("http://ec2-52-91-28-32.compute-1.amazonaws.com:5000/")
...
def load_model_info(file_path: str) -> dict:
    ...
    try:
        ...
        logger.debug('Model info laoded from %s', file_path)
        return model_info
...
def register_model(model_name: str, model_info: dict):
    ...
    try:
        model_uri = f"run:/{model_info['run_id']}/{model_info['model_path']}"
