...
file_handler = logging.FileHandler('model_building_errrors.log')
...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error('Unexpected errer occured while loading the data: %s', e)
        raise

def apply_tfidf(train_data: pd.DataFrame, max_features: int, ngram_range: tuple) -> tuple:
    """Apply TF-IDF with ngram to the data"""
    try:
