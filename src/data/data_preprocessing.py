...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    """Save the Preprocess train and test datasets."""
    try:
...
def main():
    try:
        ...
        test_precessed_data = normalize_text(test_data)

        # Save the processed data
        save_data(train_processed_data, test_precessed_data, data_path='./data')
